...
class pithermalcam:
    ...
    def _setup_therm_cam(self):
        ...
        # Setup camera
        self.i2c = busio.I2C(board.SCL, board.SDA, frequency=100000)  # setup I2C
        # Jerv - works on setup 8000 000 -> 16 & 8 fps
        # 500 000 -> 32 HZ for 11 fps
        self.mlx = adafruit_mlx90640.MLX90640(self.i2c)  # begin MLX90640 with I2C comm
        self.mlx.refresh_rate = adafruit_mlx90640.RefreshRate.REFRESH_32_HZ  # set refresh rate
        time.sleep(0.1)
